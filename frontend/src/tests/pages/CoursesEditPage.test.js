...
describe("CoursesEditPage tests", () => {
    ...
    describe("tests where backend is working normally", () => {
        ...
        test("Changes when you click Update", async () => {
            ...
            fireEvent.change(endField, { target: { value: "2025-03-12T00:00" } })
            ...
            expect(axiosMock.history.put[0].params).toEqual({ id: 17, name: "CS 148", endDate: "2025-03-12T00:00", startDate: "2024-01-10T00:00", school: "UCSB", term: "w23", githubOrg: "ucsb-cs156-w23" });
